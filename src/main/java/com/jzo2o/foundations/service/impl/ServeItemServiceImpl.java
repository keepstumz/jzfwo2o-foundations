...
public class ServeItemServiceImpl extends ServiceImpl<ServeItemMapper, ServeItem> implements IServeItemService {
    ...
    public void deactivate(Long id) {
        ...
        int count = iServeService.queryServeCountByServeItemIdAndSaleStatus(id, FoundationStatusEnum.ENABLE.getStatus());
        if(count > 0){
            throw new ForbiddenOperationException("存在区域上架该服务,禁止禁用该服务");
        }
